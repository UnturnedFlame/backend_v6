...
urlpatterns = [
    ...
    path("user/get_private_algorithm_files/", views.get_private_algorithm_files),
    ...
    path("user/upload_model_report/", views.upload_report),
    path("user/generate_model_evaluation_report/", views.generate_model_evaluation_report),
    path("fetch_model_report/", views.fetch_model_report),
    ...
    path("export_model/", views.user_export_model),
